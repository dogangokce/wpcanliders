...
if ( ! class_exists( 'Canliders1_Uninstall' ) ) {
	class Canliders1_Uninstall {
		...
		/**
		 * Remove canliders1 specific options.
		 *
		 * @since 3.0.0
		 */
		private static function remove_options() {
			delete_option( 'canliders1_url' );
			delete_option( 'canliders1_salt' );
			delete_option( 'canliders1_plugin_version' );
			delete_option( 'canliders1_default_roles_set' );
		}
	}
}
Canliders1_Uninstall::uninstall();
