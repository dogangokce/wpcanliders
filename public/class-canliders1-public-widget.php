 ...
 */
class Canliders1_Public_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array(
				...
				'description'                 => __( 'Displays a CanliDers1 login form.', 'canliders1' ),
	...
	public function widget( $args, $instance ) {
		...
		echo Canliders1_Tokens_Helper::join_form_from_tokens_string( $display_helper, $tokens_string, $author );
	...
	public function form( $instance ) {
		...
		include 'partials/canliders1-create-widget-display.php';
	}
